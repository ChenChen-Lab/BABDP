...
open (OUT_T, ">$assembly_03/pick_1k_sequence.sh")||die;
	...
	my $cmd_3="$metaspades -t 60 -m 500  -1 $qc_01/$sample/$sample.unmap.1.fq.gz -2 $qc_01/$sample/$sample.unmap.2.fq.gz  --only-assembler  -o $assembly_03/assembly/$sample";
	print OUT3 $cmd_3."\n";
...
open (OUT_T, ">$assembly_03/pick_1k_sequence.sh")||die;
        ...
        my $cmd_3="$metaspades  -t 60  -m 500  -1 $fq1 -2 $fq2  --only-assembler  -o $assembly_03/assembly/$sample";
        print OUT3 $cmd_3."\n";
